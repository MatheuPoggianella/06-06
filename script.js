const cableData = [
    { distance: 100, connector: 'RJ45', standard: '10Base-T', type: 'Par trançado (CAT3 ou superior)', maxDistance: '100 m', speed: '10 Mbps' },
       ...
       { distance: 100, connector: 'RJ45', standard: '1000Base-T (Gigabit Ethernet)', type: 'Par trançado (CAT5e ou superior)', maxDistance: '100 m', speed: '1 Gbps' },
       { distance: 100, connector: 'RJ45', standard: '10GBase-T', type: 'Par trançado (CAT6a ou superior)', maxDistance: '100 m', speed: '10 Gbps' },
       { distance: 2000, connector: 'SC ou LC', standard: '100Base-FX', type: 'Fibra: Monomodo', maxDistance: '2 km', speed: '100 Mbps' },
       { distance: 550, connector: 'SC ou LC', standard: '1000Base-SX', type: 'Fibra: Monomodo', maxDistance: '550 m', speed: '1 Gbps' },
       { distance: 550, connector: ' SC ou LC', standard: ' 1000Base-LX', type: 'Monomodo (também compatível com multimodo)', maxDistance: '550 m', speed: '1 Gbps' },
       { distance: 300, connector: 'LC', standard: '10GBase-SR', type: 'Fibra: Monomodo', maxDistance: '300 m', speed: '10 Gbps' },
       { distance: 10000, connector: 'LC', standard: '10GBase-LR', type: 'Fibra: Monomodo', maxDistance: '10 km', speed: '10 Gbps' },
       { distance: 150, connector: 'MPO (conector de fibra óptica de múltiplos conectores)', standard: '40GBase-SR4', type: 'Fibra: Monomodo', maxDistance: '150 m', speed: '40 Gbps' },
       { distance: 100, connector: 'MPO', standard: '100GBase-SR10', type: 'Multimodo', maxDistance: '100 m', speed: '100 Gbps' },
